...
const Navbar = () => {               //jabtak poora react router dom nahi use hoga, agar sirf yahan link-to laga diya toh errors dega. bas class ko classname and </> band karke run karo starting me. it'll work
